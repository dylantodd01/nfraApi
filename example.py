...
response = urllib.request.urlopen(station_ids_url, context=context).read()
...
query = "station=53001&format=json-object"
print("{BASE}/station-info?{QUERY}".format(BASE=base_url,
                                                         QUERY=query))
